...
define("TIMEDIFF", 0);
define("DOMINIO","http://escuderiaservicios.com/q-subastas/");
define("MAILFROM","contacto@escuderiaservicios.com");
...
function envia_mail($to, $titulo, $mensaje){
	try{
		...
		$headers = array(
		  'From: "EscuderÌ≠a" <'.constant("MAILFROM").'>' ,
...
function envia_mensaje_invitacion($claveApi, $idusuario, $idsubasta){
 		...
 		// $mensaje = "<html><meta http-equiv='Content-Type' content='text/html; charset=UTF-8' />	<body><h2>Bienvenido a escuder√≠a</h2><p>Usted fue invitado a participar en una subasta por favor concluya el registro para poder participar: <a href=\"msusano.com/Subastas/home.php?s=invitacion&claveapi=". $claveApi."&idusuario=".$idusuario."\">Confirmar mail</a><br /><p>Si no puede dar click en el encace puede copiar el c√≥digo  ". $claveApi." en la pantalla de verificaci√≥n </p></body></html>";
	 	// return $mensaje;
